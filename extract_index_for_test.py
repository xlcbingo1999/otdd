import torch
from utils.models import resnet8, CNN
...
def get_df_config():
    ...
    parser.add_argument("--test_dataset_names", type=str, nargs="+", default=["EMNIST"]) # SVHN, USPS, STL10, CIFAR10, KMNIST, FashionMNIST
    parser.add_argument("--test_sample_nums", type=int, nargs="+", default=[2000])
...
if MODEL_NAME == "CNN":
    ...
    model = resnet8(num_classes=len(train_dataset.classes))
